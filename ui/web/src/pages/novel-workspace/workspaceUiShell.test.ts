...
describe('commercial writing workspace UI shell', () => {
  ...
  test('shows auto creation director as the longform control workspace', () => {
    ...
    expect(directorWorkspace).toContain('今日指挥条')
    expect(directorWorkspace).toContain('model.todayCommandDeck')
    expect(directorWorkspace).toContain('auto-director-command-deck')
    ...
    expect(directorWorkspace).toContain('万订护栏')
    expect(directorWorkspace).toContain('todayCommandDeck.qualityGates')
    expect(directorWorkspace).toContain('auto-director-command-quality-gates')
    expect(directorWorkspace).toContain('auto-director-command-quality-gate')
    expect(directorWorkspace).toContain('连写放行说明')
    expect(directorWorkspace).toContain('todayCommandDeck.releaseRationale')
    expect(directorWorkspace).toContain('auto-director-release-rationale')
    expect(directorWorkspace).toContain('auto-director-command-flow')
    expect(directorWorkspace).toContain('todayCommandDeck.flow')
    expect(directorWorkspace).toContain('todayCommandDeck.action')
    ...
    expect(directorCss).toContain('.auto-director-command-deck')
    ...
    expect(directorCss).toContain('.auto-director-command-flow')
    expect(directorCss).toContain('.auto-director-command-quality-gates')
    expect(directorCss).toContain('.auto-director-command-quality-gate')
    expect(directorCss).toContain('.auto-director-release-rationale')
    expect(directorCss).toContain('.auto-director-command-flow-step-active')
