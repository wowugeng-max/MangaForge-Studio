...
describe('commercial writing workspace UI shell', () => {
  ...
  test('separates the writing cockpit from delivery and collapsed workspace bars', () => {
    ...
    expect(component).toContain('writing-cockpit-collapsed-controls')
    ...
    expect(css).toContain('.writing-cockpit-collapsed-controls')
  ...
  test('offers automatic fixes for preflight character and setting gaps', () => {
    ...
    expect(projectWorkspace).toContain('角色卡不足')
    expect(projectWorkspace).toContain('设定工坊不足')
    expect(projectWorkspace).toContain('本章设定调用不足')
    expect(projectWorkspace).toContain('补角色卡')
    expect(projectWorkspace).toContain('提炼设定工坊')
    expect(projectWorkspace).toContain('匹配本章设定调用')
    expect(projectWorkspace).toContain('自动补齐并继续生成')
    ...
    expect(projectWorkspace).toContain('调用大模型')
    expect(projectWorkspace).toContain('不调用大模型')
  })
