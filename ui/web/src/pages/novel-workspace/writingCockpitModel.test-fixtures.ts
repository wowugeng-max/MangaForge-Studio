...
export function proseQualityReview(overrides: Record<string, any> = {}) {
...
export function editorReportReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    report: {
      overall_score: 68,
...
export function editorRevisionReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
...
export function storylineSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    storyline_sync: {
...
export function qualityAuditSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    quality_audit_sync: {
...
export function qualityAuditRepairReceiptSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function chapterHandoffSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function chapterHandoffDeltaSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function intentConfirmationSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function benchmarkRecallSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function storyUnitSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    story_unit_sync: {
...
export function assetIntakeReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    discovered_assets: [
...
export function ipSceneIntakeReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    ip_scene_candidates: [
...
export function readabilityReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    readability_review: {
...
export function chapterAttractionReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function storyDriveSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    story_drive_sync: {
...
export function characterArcSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    character_arc_sync: {
...
export function coreDriftReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    core_drift: {
...
export function readerPayoffSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    reader_payoff_sync: {
...
export function readerRetentionSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function chapterBenchmarkSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function styleSampleSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    style_sample_sync: {
...
export function readerExpectationSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function runwaySyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    runway_sync: {
...
export function innovationSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    innovation_sync: {
...
export function signatureSceneSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function volumeBeatSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
    volume_beat_sync: {
...
export function first30RetentionReview(overrides: Record<string, any> = {}) {
  const report = {
    score: 76,
    status: 'needs_repair',
...
export function deliveryRiskConvergenceReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
...
export function governanceRecheckSyncReview(overrides: Record<string, any> = {}) {
  const payload = {
    chapter_id: 101,
    chapter_no: 1,
