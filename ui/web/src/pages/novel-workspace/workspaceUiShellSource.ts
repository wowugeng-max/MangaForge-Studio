...
export function directorModelSource() {
  ...
  directorModelSourceCache = [
    ...
    sourceCached('auto-creation/model/types-status.ts', localSourceCache),
    sourceCached('auto-creation/model/types-models.ts', localSourceCache),
    sourceCached('auto-creation/model/types-models-batch.ts', localSourceCache),
    sourceCached('auto-creation/model/types-models-ops.ts', localSourceCache),
    ...
    sourceCached('auto-creation/model/helpers-risk-delivery-core.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-risk-delivery-config.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-risk-delivery-resolve.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-risk-delivery-recovery-queue.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-risk-recovery-governance.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-risk-recovery-governance-core.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-risk-recovery-governance-reviews.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-risk-recovery-governance-reviews-batch.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-risk-recovery-governance-reviews-chapter.ts', localSourceCache),
    ...
    sourceCached('auto-creation/model/helpers-batch-guardrail-preflight.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-batch-guardrail-core.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-batch-guardrail-core-signals-state.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-batch-guardrail-core-decision.ts', localSourceCache),
    ...
    sourceCached('auto-creation/model/helpers-batch-risk-radar-compute-guards.ts', localSourceCache),
    ...
    sourceCached('auto-creation/model/helpers-safe-batch-recovery-core.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-safe-batch-recovery-decision.ts', localSourceCache),
    sourceCached('auto-creation/model/helpers-safe-batch-recovery-default-lane.ts', localSourceCache),
    ...
    sourceCached('auto-creation/model/helpers-recovery-evidence-trends-batch.ts', localSourceCache),
...
export function planningWorkspaceSource() {
  ...
  planningWorkspaceSourceCache = [
    ...
    sourceCached('planning/model/planning-workspace-builder-desks-shared.ts', localSourceCache),
    sourceCached('planning/model/planning-workspace-builder-desks-serial.ts', localSourceCache),
    sourceCached('planning/model/planning-workspace-builder-desks-longform.ts', localSourceCache),
...
export function projectWorkspaceSource() {
  ...
  projectWorkspaceSourceCache = [
    ...
    sourceCached('shell/use-novel-project-workspace-model.tsx', localSourceCache),
    sourceCached('shell/use-novel-workspace-base-model.tsx', localSourceCache),
    sourceCached('shell/build-novel-workspace-ready-runtime.tsx', localSourceCache),
    sourceCached('shell/workspace-area-tabs.tsx', localSourceCache),
    sourceCached('shell/workspace-view-bind-core-handlers.ts', localSourceCache),
    sourceCached('shell/workspace-view-bind-action-handlers.ts', localSourceCache),
    sourceCached('shell/workspace-cockpit-primary-override.ts', localSourceCache),
    sourceCached('shell/use-workspace-chapter-loads.ts', localSourceCache),
    sourceCached('shell/use-workspace-domain-models.ts', localSourceCache),
    ...
    sourceCached('shell/workspace-deferred-surfaces-ops-toolbox.tsx', localSourceCache),
    sourceCached('shell/workspace-deferred-surfaces-ops-extra-modals.tsx', localSourceCache),
    sourceCached('shell/workspace-deferred-surfaces-ops-creative-modals.tsx', localSourceCache),
    sourceCached('shell/workspace-deferred-surfaces-ops-bible-modals.tsx', localSourceCache),
...
export function taskCenterSource() {
  ...
  taskCenterSourceCache = [
    ...
    sourceCached('task-center/drawer-model-helpers.ts', localSourceCache),
    sourceCached('task-center/drawer-model-helpers-basics.ts', localSourceCache),
    sourceCached('task-center/drawer-model-helpers-quality.ts', localSourceCache),
    sourceCached('task-center/drawer-model-helpers-repair.ts', localSourceCache),
    sourceCached('task-center/drawer-model-helpers-batch.ts', localSourceCache),
    sourceCached('task-center/drawer-model-tags.tsx', localSourceCache),
    ...
    sourceCached('task-center/drawer-snapshots-structure.ts', localSourceCache),
    sourceCached('task-center/drawer-snapshots-policy.ts', localSourceCache),
...
export function writingCockpitModelSource() {
  ...
  writingCockpitModelSourceCache = [
    ...
    sourceCached('writing-cockpit/model/cockpit-acceptance-desk-story-state.ts', localSourceCache),
    sourceCached('writing-cockpit/model/cockpit-acceptance-desk-hidden.ts', localSourceCache),
    sourceCached('writing-cockpit/model/cockpit-acceptance-desk-chapter.ts', localSourceCache),
