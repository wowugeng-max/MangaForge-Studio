...
describe('commercial writing workspace UI shell a a', () => {
  ...
  test('keeps manual writing visible by collapsing auxiliary writing panels', () => {
    ...
    expect(source('workspace-center-quality-revision-panel.tsx')).toContain('自定义修订指令')
    expect(source('workspace-center-quality-revision-panel.tsx')).toContain('清英文夹杂')
    expect(source('workspace-center-quality-revision-panel.tsx')).toContain('按报告+自定义修订')
