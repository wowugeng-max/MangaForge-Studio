...
const longWriteChapter: KernelContract = {
  ...
  outputs: [
    { artifact_kind: 'chapter_text', glob: '正文/第{{chapter_pad}}章_*.md', binding: 'chapters.rewrite', required: true },
    { artifact_kind: 'tracking_doc', glob: '追踪/_tracking-state.json', binding: 'kernel_only', required: true },
    { artifact_kind: 'tracking_doc', glob: '追踪/逐章记录/第{{chapter_pad}}章.md', binding: 'kernel_only', required: true },
    { artifact_kind: 'tracking_doc', glob: '追踪/**/*.md', binding: 'kernel_only', required: false },
  ],
  write_scope: ['正文/', '追踪/'],
  ignore: ['.story-review/'],
  gates: ['require_chapter_file', 'reject_outline_artifact', 'require_chapter_tracking'],
