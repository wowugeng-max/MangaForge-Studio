...
import type {
  GenerateChapterForGroupDeps,
  GenerateChapterForGroupOptions,
} from './generate-chapter-for-group-contracts'

export function createGenerateChapterForGroupMethods(deps: GenerateChapterForGroupDeps) {
