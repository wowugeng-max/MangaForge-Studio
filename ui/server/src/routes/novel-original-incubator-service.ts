...
export function createNovelOriginalIncubatorService() {
  const buildOriginalIncubatorPrompt = (project: any, body: any) => {
    ...
    'writing_bible: {promise,world_rules,mainline,volume_plan,style_lock,safety_policy,forbidden,target_reader_contract,genre_positioning_contract,plot_special_topics_contract,core_contract_radar,reader_retention_contract,opening_strategy_contract}',
