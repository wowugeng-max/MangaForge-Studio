...
export type GenreCatalogRoute = {
  framework: string
  keywords: string[]
  contract: Omit<OhStoryGenreCatalogContract, 'source' | 'matched_framework' | 'route_reason'>
}

export const GENRE_CATALOG_ROUTES: GenreCatalogRoute[] = [
  {
    framework: '小三/婚恋',
...
export const GENERIC_GENRE_CATALOG_CONTRACT: OhStoryGenreCatalogContract = {
  source: 'oh_story_genre_catalog_v1',
