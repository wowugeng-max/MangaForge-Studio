...
export async function getStatusSnapshot(activeWorkspace: string) {
  ...
  return {
    ...
    features: {
      ...
      novel_persistent_worker_recovery: true,
      novel_scene_level_production: true,
      novel_hard_quality_gate: true,
      novel_context_package_editor: true,
      novel_reference_coverage_diagnostics: true,
      novel_model_cost_strategy_stats: true,
      novel_enhanced_story_state: true,
      novel_route_module_manifest: true,
    },
