...
const SOFT_BASELINES: Record<string, number> = {
  ...
  'novel-writing-service/service/generate-chapter-quality-prestore.ts': 120,
  'novel-writing-service/service/generate-chapter-quality-prestore-loop.ts': 550,
  'novel-writing-service/service/generate-chapter-quality-prestore-finalize.ts': 700,
  'novel-writing-service/service/story-state-machine.ts': 250,
  'novel-writing-service/service/story-state-machine-prepare.ts': 350,
  'novel-writing-service/service/story-state-machine-update.ts': 280,
  'novel-writing-service/service/story-state-machine-update-phase-a.ts': 450,
  'novel-writing-service/service/story-state-machine-update-phase-b.ts': 320,
  ...
  'novel-writing-service/service/paragraph-prose-context-sections.ts': 80,
  'novel-writing-service/service/paragraph-prose-context-sections-lead.ts': 250,
  'novel-writing-service/service/paragraph-prose-context-sections-body.ts': 400,
  'novel-writing-service/service/paragraph-prose-context-sections-tail.ts': 200,
  ...
  'novel-writing-service/service/prose-self-review-run.ts': 250,
  'novel-writing-service/service/prose-self-review-run-normalize.ts': 550,
  'novel-writing-service/service/prose-self-review-run-revision.ts': 200,
  ...
  'routes/novel-chapter-context-routes.ts': 550,
  'routes/novel-chapter-context-material-repair-route.ts': 250,
  'routes/novel-chapter-context-helpers.ts': 400,
  'routes/novel-generation/register-chapter-groups.ts': 80,
  'routes/novel-generation/register-chapter-groups-start.ts': 400,
  'routes/novel-generation/register-chapter-groups-unattended.ts': 320,
  'routes/novel-generation/register-chapter-groups-run.ts': 250,
  'novel-writing-service/quality/structured-review-required-fields.ts': 50,
  'novel-writing-service/quality/structured-review-required-fields-core.ts': 450,
  ...
  'novel-writing-service/post-delivery/quality-sync-reports-benchmark-blueprint-recall.ts': 600,
  ...
  'novel-writing-service/service/generate-chapter-for-group-contracts.ts': 100,
