import type { NovelPipelineSnapshot, NovelProjectRecord, NovelRunRecord } from './types'
import { openDb, ensureSqliteSchema } from './db'
import { ensureLegacyNovelStoreImportedForRead } from './legacy-import'
import { dedupById } from './normalize'
import { NOVEL_PIPELINE_SQL_TRIM_CHARS, NOVEL_PIPELINE_CHAPTER_REVIEW_TYPES, NOVEL_PIPELINE_GOVERNANCE_REVIEW_TYPES, NOVEL_PIPELINE_BATCH_RUN_TYPES, NOVEL_PIPELINE_REPAIR_RUN_TYPES, NOVEL_PIPELINE_GOVERNANCE_RUN_TYPES, pipelineJsonTruthySql, pipelineAnyJsonTruthySql, pipelineJsonAnchorTruthySql, projectNovelPipelineReview } from './pipeline-sql'
import { worldbuildingFromRow, characterFromRow, outlineFromRow, chapterFromRow, reviewFromRow } from './row-mappers'
