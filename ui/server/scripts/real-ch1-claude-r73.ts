...
const OUT = process.env.OUT_DIR || "/tmp/mf-ch1-pov-36-r73"
...
writeFileSync(resolve(WORKSPACE, "zhuque-inputs/ch1-pov-36-r73.txt"), cleaned)
writeFileSync(resolve(WORKSPACE, "zhuque-inputs/ch1-pov-36-r73-raw.txt"), prose)
writeFileSync(join(OUT, "stages.json"), JSON.stringify(stages, null, 2))
console.log(JSON.stringify({
  phase: "done",
